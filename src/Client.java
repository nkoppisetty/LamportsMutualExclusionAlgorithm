...
public class Client {
    ...
    private int client_ports[] = new int [] {56394,56395,56396,56397,56398};
    ...
    public Client(String node){
        try {
            ...
            coclient = new Socket[5];
            douts = new DataOutputStream[5];
            diss = new DataInputStream[5];
    ...
    public void enquire(){
        try {
            ...
            int randNode = random.nextInt(3);
            client = new Socket(servers[randNode],server_ports[randNode]);
    ...
    public static void main(String[] args) {
        if(args.length < 1){
            System.out.println("Please provide the client number (1 to 5)");
        }else{
            new Client(args[0]);
        }
    }
